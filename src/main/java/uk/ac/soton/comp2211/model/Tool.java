...
public class Tool {
  ...
  public void recalculate(AdvancedObstacle obstacle, String type) {
    SystemMessageBox.addMessage("Calculation type: " + type);
    SystemMessageBox.addMessage("Selected Obstacle: " + obstacle.getObstacleName() + " Height: " + obstacle.getHeight() + " Width" + obstacle.getWidth() +" Distance: " + obstacle.getDistanceFromThreshold() + " Distance from Center-line: " + obstacle.getDistanceFromCentre());
